...
export default function AdminPage() {
  ...
  const toggleGroups = {
    ...
    features: [
      ...
      { key: 'enableReferenceBooks' as const, label: 'Enable Reference Textbooks', desc: 'Show reference books section for courses. If disabled, reference books are hidden.' },
      ...
      { key: 'enableBookRequests' as const, label: 'Enable Book Request Board', desc: 'Allow users to submit requests for reference books. If disabled, book request features are disabled.' },
